...
class ReRequestedServiceApproved extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Re-requested Service Approved - ' . $this->reRequestedService->service_name,
        );
    }
    ...
    public function content(): Content
    {
        $view = $this->recipientType === 'customer' 
            ? 'emails.re-requested-service-approved-customer'
            : 'emails.re-requested-service-approved-professional';
