<aside class="app-sidebar sticky" id="sidebar">
    ...
    <div class="main-sidebar-header">
        <a href="index-2.html" class="header-logo">
            <img src="{{ asset('customer/assets/images/tazen_logo-01-removebg-preview.png') }}" alt="logo" class="desktop-logo">
            {{-- <img src="assets/images/brand-logos/toggle-dark.png" alt="logo" class="toggle-dark">
            <img src="assets/images/brand-logos/desktop-dark.png" alt="logo" class="desktop-dark"> --}}
            <img src="{{ asset('customer/assets/images/tazen_logo-01-removebg-preview.png') }}" alt="logo" class="toggle-logo">
        </a>
    </div>
    ...
    <div class="main-sidebar" id="sidebar-scroll">
        ...
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <!-- Start::slide -->
                <li class="slide has-sub">
                    <a href="{{ route('customer.add-profile') }}" class="side-menu__item">
                    ...
                    <ul class="slide-menu child1">
                        <li class="slide side-menu__label1">
                            <a href="javascript:void(0)">Add Profile</a>
                        </li> 
                    </ul>
                </li>
                <!-- End::slide -->
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">Manage Appointment</span>
                        <i class="ri-arrow-down-s-line side-menu__angle"></i>
                    </a>
                    <ul class="slide-menu child1">
                        <li class="slide side-menu__label1">
                        ...
                        <li class="slide">
                            <a href="javascript:void(0);" class="side-menu__item">All Appointment</a>
                        </li>
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">Upcoming Appointment
                ...
                <!-- Start::slide__category -->
                <li class="slide__category"><span class="category-name">Billing</span></li>
                <!-- End::slide__category -->
                ...
                <li class="slide has-sub">
                    <a href="javascript:void(0);" class="side-menu__item">
                        ...
                        <span class="side-menu__label">All Billing</span>
                        {{-- <i class="ri-arrow-down-s-line side-menu__angle"></i> --}}
                    </a>
                    <ul class="slide-menu child1">
                        <li class="slide side-menu__label1">
                            <a href="javascript:void(0)">All Billing</a>
                        </li>
                    </ul>
                </li>
                <!-- End::slide -->
