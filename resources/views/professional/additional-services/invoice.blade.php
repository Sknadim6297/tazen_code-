            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-group">
                        ...
                        <a href="{{ route('professional.additional-services.invoice.pdf', $service->id) }}" 
                           class="btn btn-success" target="_blank">
                            <i class="fas fa-download"></i> Download PDF
                        </a>
                        <a href="{{ route('professional.additional-services.index') }}" class="btn btn-secondary">
                ...
                <div class="card-body" id="invoice-content">
                    ...
                    <div class="pricing-breakdown mb-4 p-4 bg-light rounded">
                        <h5 class="text-primary">Pricing Flow</h5>
                        <div class="d-flex justify-content-around align-items-center flex-wrap pricing-flow">
                            ...
                            <!-- Customer Negotiated Price (only if different from original) -->
                            ...
                            <div class="text-center price-stage">
                                ...
                                <div class="price-label text-muted">Customer Negotiated</div>
                            </div>
                            @endif
                            ...
                            <div class="text-center price-stage">
                                ...
                                <div class="price-label text-muted">Admin Final Price</div>
                            </div>
                            @endif
                            ...
                            <div class="text-center price-stage">
                                ...
                                <div class="price-label text-muted">Final Price (with GST)</div>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <!-- GST Breakdown -->
                    <div class="mb-4">
                        <h5 class="text-primary">Price Breakdown</h5>
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <tbody>
                                    <tr>
                    ...
                    @if($showNegotiation)
                    <div class="negotiation-history mb-4 p-3 bg-warning bg-opacity-10 rounded border-start border-warning border-4">
                        <h5 class="text-primary">Negotiation History</h5>
                        <div class="mb-2">
