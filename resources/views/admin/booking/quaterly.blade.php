...
<div class="main-content app-content">
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            <div>
                <h1 class="page-title fw-medium fs-18 mb-2">Quarterly Booking</h1>
                <div>
                    <nav>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Booking</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Quarterly</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="card custom-card filter-card mb-4">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    ...
                    Filter Quarterly Bookings
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.quaterly') }}" method="GET" id="searchForm">
                    <div class="row g-3">
                        <!-- Search Input -->
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-2 justify-content-end pt-2">
                                ...
                                <a href="{{ route('admin.quaterly') }}" class="btn btn-outline-secondary px-4">
        ...
        <form id="export-form" method="GET" action="{{ route('admin.booking.quarterly.export') }}">
                ...
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        <div class="card-title">
                            Total Quarterly Bookings: {{ $bookings->total() }}
                        </div>
                    </div>
                                        ...
                                        <td>
                                            @if($booking->latest_meeting_link)
                                                <div class="meeting-link-container">
                                                    <a href="{{ $booking->latest_meeting_link }}" class="btn btn-sm btn-success btn-meeting-link" target="_blank">
                                                        <i class="bi bi-camera-video me-1"></i> Join Meeting
                                                    </a>
                                                    <button class="btn btn-sm btn-outline-secondary copy-link-btn mt-1" 
                                                           data-link="{{ $booking->latest_meeting_link }}">
...
<script>
    ...
    window.exportData = function(type) {
        ...
        if (type === 'excel') {
            form.action = "{{ route('admin.booking.quarterly.export-excel') }}";
        } else if (type === 'pdf') {
            form.action = "{{ route('admin.booking.quarterly.export') }}";
        }
