...
<div class="main-content app-content">
    <div class="container-fluid">
                ...
                <div>
                    <nav>
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Free Hand</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="card custom-card filter-card mb-4">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    ...
                    Filter Free Hand Bookings
                </h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.freehand') }}" method="GET" id="searchForm">
                    <div class="row g-3">
                        <!-- Search Input -->
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-2 justify-content-end pt-2">
                                ...
                                <a href="{{ route('admin.freehand') }}" class="btn btn-outline-secondary px-4">
        ...
        <form id="export-form" method="GET" action="{{ route('admin.booking.freehand.export') }}">
...
<script>
    ...
    window.exportData = function(type) {
        ...
        if (type === 'excel') {
            form.action = "{{ route('admin.booking.freehand.export-excel') }}";
        } else if (type === 'pdf') {
            form.action = "{{ route('admin.booking.freehand.export') }}";
        }
