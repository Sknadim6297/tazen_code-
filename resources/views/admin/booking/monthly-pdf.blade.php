...
<head>
    ...
    <title>Monthly Bookings Report</title>
    <style>
        @font-face {
...
<body>
            ...
            <tr>
                ...
                <td>
                    @if($booking->nextBooking)
                        {{ \Carbon\Carbon::parse($booking->nextBooking->date)->format('d M Y') }}
                        <br>{{ $booking->nextBooking->time_slot }}
                    @else
    ...
    <div class="footer">
        © {{ date('Y') }} Tazen - Monthly Bookings Report
    </div>
