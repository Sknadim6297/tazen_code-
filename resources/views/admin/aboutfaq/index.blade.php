                        ...
                        <div class="d-flex">
                            ...
                            <div class="modal fade" id="create-task" tabindex="-1" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <form action="{{ route('admin.aboutfaq.store') }}" method="POST">
                                        @csrf
                                ...
                                <tbody>
                                    @foreach ($aboutfaqs as $faq)
                                        <tr>
                                            ...
                                            <td>{{ $faq->answer4 }}</td>
                                            <td>
                                                <a href="{{ route('admin.aboutfaq.edit', $faq->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                                <form action="{{ route('admin.aboutfaq.destroy', $faq->id) }}" method="POST" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
