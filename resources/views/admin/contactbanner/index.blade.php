            ...
            <div class="col-xxl-12 col-xl-12">
                <div class="card custom-card">
                    <div class="card-header justify-content-between">
                        ...
                        <div class="d-flex">
                            <button class="btn btn-sm btn-primary btn-wave waves-light" data-bs-toggle="modal" data-bs-target="#create-task"><i class="ri-add-line fw-medium align-middle me-1"></i> Create Contact Banner</button>
                                    ...
                                    <form action="{{ route('admin.contactbanner.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h6 class="modal-title">Add Contact Banner</h6>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary">Add Contact Banner</button>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <tbody>
                                    @foreach ($contactbanners as $key => $banner)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.contactbanner.edit', $banner->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                                <form action="{{ route('admin.contactbanner.destroy', $banner->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Are you sure?');">
                                                    @csrf
                                                    @method('DELETE')
