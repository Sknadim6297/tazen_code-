...
<main>
    <div class="opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.4)" style="background: url('{{ asset('storage/' . $service->banner_image) }}') center center / cover no-repeat;">
        <div class="container">
            <div class="row">
                <div class="col-xl-9 col-lg-10">
                    <h1>{{ $service->title ?? 'Find Astrologer/Priest near you' }}</h1>
                    <p>{{ $service->short_description ?? 'Book a Consultation by Appointment, Chat or Video call' }}</p>
                    <form>
                        <div class="row g-0 custom-search-input">
                            <div class="col-md-9">
                                <div class="form-group">
                                    <input class="form-control" type="text" placeholder="{{ $service->placeholder_text ?? 'Chat or Video Call ....' }}">
                                </div>
                            </div>
                            <div class="col-md-3">
    ...
    <div class="bg_gray need-help-service">
        <div class="container margin_60_40">
            ...
            <div class="row justify-content-md-center how_2">
                <div class="col-lg-5">
                    <h1>Need help finding an Astrologer/Priest ?</h1>
                    <p>You can find the best Astrologer/Priest on Tazen. Start your search and get free quotes now!  </p>
                ...
                <div class="col-lg-5 text-center">
                    <figure>
                        <img src="img/professionals_photos/plam-astro.jpg" data-src="img/professionals_photos/plam-astro.jpg" alt="" class="img-fluid lazy" width="360" height="380">
                    </figure>
                </div>
