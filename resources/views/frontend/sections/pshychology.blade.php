...
<main>
    <div class="hero_single psychology">
        <div class="opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.4)">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-10">
                        <h1>Find Psychologist near you</h1>
    ...
    <div class="bg_gray need-help-service">
        <div class="container margin_60_40">
            ...
            <div class="row justify-content-md-center how_2">
                <div class="col-lg-5">
                    <h1>Need help finding an Psychiatrist ?</h1>
                    <p>You can find the best Psychiatrist on Tazen. Start your search and get free quotes now!  </p>
