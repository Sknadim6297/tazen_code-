                                ...
                                @foreach($rates as $rate)
                                    ...
                                    <div class="tab-pane fade @if($loop->first) show active @endif" id="mobile-{{ $safeId }}" role="tabpanel" aria-labelledby="mobile-{{ $safeId }}-tab">
                                        <div class="appointment-details" style="max-width:500px; margin:auto;">
                                            ...
                                            @if($rate->subService)
                                                <div style="background: #e3f2fd; border-left: 4px solid #2196f3; padding: 8px 12px; margin-bottom: 12px; border-radius: 4px;">
                                                    <small style="color: #1976d2; font-weight: 600;">
                                                        <i class="icon_tag" style="margin-right: 5px;"></i>
                                                        Service: {{ $rate->subService->service->name ?? 'General Service' }} → {{ $rate->subService->name }}
                                                    </small>
                                                </div>
                                            @elseif($requestedSubServiceId)
                                                <div style="background: #f3e5f5; border-left: 4px solid #9c27b0; padding: 8px 12px; margin-bottom: 12px; border-radius: 4px;">
                                                    <small style="color: #7b1fa2; font-weight: 600;">
                                                        <i class="icon_tag" style="margin-right: 5px;"></i>
                                                        General Service Rate (Sub-service specific rate not available)
                                                    </small>
                                                </div>
                                            @else
                                                <div style="background: #e8f5e8; border-left: 4px solid #4caf50; padding: 8px 12px; margin-bottom: 12px; border-radius: 4px;">
                                                    <small style="color: #388e3c; font-weight: 600;">
                                                        <i class="icon_tag" style="margin-right: 5px;"></i>
